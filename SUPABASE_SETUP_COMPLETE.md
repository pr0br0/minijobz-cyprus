# 🗄️ Supabase Database Setup for MiniJobZ Cyprus

## 🚀 Quick Setup Guide

### 1. Create Supabase Project
1. Go to https://supabase.com (opened in browser)
2. Click "Start your project" 
3. Sign in with GitHub account
4. Click "New project"
5. Choose organization: `pr0br0`
6. Project name: `minijobz-cyprus`
7. Database password: `Generate a password` (save it!)
8. Region: Choose closest to Cyprus (Europe West)
...
anon/public key: eyJ0eXAiOiJKV1QiLCJhbGciOi...
service_role key: eyJ0eXAiOiJKV1QiLCJhbGciOi... (secret!)
```
...
After creating your Supabase project, add these to Railway:
